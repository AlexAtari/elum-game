...
In Runde 1 wird die Planungsansicht nach dem Aufruf zunächst durch eine fünfsekündige Auktionsankündigung ersetzt. Ressource und Initiator stehen einmal im Kopf; in der Arena erscheinen nur noch Countdown und der knappe Richtungshinweis für die folgende Rollenwahl. Eine zweite Bereitmachen-Karte sowie Ressourcen-, Lager- und Creditsübersichten bleiben ausgeblendet. Ab Runde 2 entfällt diese Einführung und der Markt beginnt direkt mit der Rollenwahl.
...
Das HQ-Gesamtlager erscheint als eine einzige kompakte Station links in der oberen Steuerzeile außerhalb der Preisarena und zeigt sowohl seinen Ankauf- als auch seinen Verkaufskurs. Es gibt weiterhin genau zwei gemeinsame Marktlinien: Die obere Linie zeigt den niedrigsten Verkaufspreis, die untere Linie das höchste Kaufgebot. Beide Linien sind bereits während der Rollenwahl sichtbar und liegen beim jeweiligen HQ-Preis. Wer sich als Verkäufer oder Käufer einordnet, wartet zunächst außerhalb des aktiven Marktes und hat noch kein aktives Angebot. Mit dem ersten Schritt in Richtung Markt erreicht der Teilnehmer die zugehörige Lagerlinie, ohne deren Preis zu verändern. Erst weitere Schritte schieben die Linie mit festem Abstand vor dem Avatar in den Markt. Beim Rückzug folgt sie bis zum HQ-Preis. Ein zusätzlicher Schritt nimmt das Angebot zurück, während die Linie am Lagerkurs oder beim nächstbesten aktiven Angebot stehen bleibt. Verkäufer stehen oberhalb der Verkaufslinie und Käufer unterhalb der Kauflinie. Der aktuelle Preis steht kompakt am rechten Ende der jeweiligen Linie; treffen beide Linien zusammen, ersetzt ein gemeinsames Preisetikett die beiden Einzelwerte. Marktteilnehmer, die ihre gewünschte Handelsmenge erreicht haben, ziehen ihr aktives Angebot sichtbar zurück. Nach Ende der Auktion wird die Arena vollständig geleert.
...
Die Auktionsarena ist die visuelle Hauptbühne der Marktphase und darf breiter als das normale Kolonie-Dashboard sein. Auf Smartphones bleibt ihre Höhe so kompakt, dass Arena und statische Pfeile gemeinsam in den sichtbaren Bereich passen. Nur während der laufenden Auktion wird das Steuerfeld auf die schmalen, vertikal zentrierten und zweizeiligen Pfeiltasten reduziert. Positionierungs- und Ergebnisphase behalten eine breitere Textspalte, damit kein Hinweis über seinen Bereich hinausragt. Das gemeinsame HQ-Lager steht außerhalb der Arena in der oberen Steuerzeile; innerhalb der Arena verlaufen vier feste, ausreichend breite Laufspuren für die Teilnehmer. Rollenangaben erhalten in jedem Avatar eine eigene volle Textzeile, sodass weder Beschriftungen abgeschnitten werden noch Avatare untereinander kollidieren. Beide Bestpreislinien besitzen dieselbe Stärke und dieselbe grüne Grundfarbe. Treffen sie für einen Handel zusammen, pulsiert die verschmolzene Linie als unmittelbares Transfersignal. Die feste Preisskala entfällt: Am rechten Rand stehen nur Minimal- und Maximalpreis, während der aktuelle Preis direkt am rechten Ende der bewegten Linie mitwandert. Vorübergehende Handelsmeldungen erscheinen außerhalb der Arena und verdecken niemals Figuren. Spätere Figuren, Animationen, Effekte und Grafiken verändern nur die Präsentation. Zustände, Preisgrenzen, Bestpreisführung, Linienübergabe, Handelsreihenfolge und Einzeltransaktionen bleiben davon unabhängig und werden nicht neu definiert.
