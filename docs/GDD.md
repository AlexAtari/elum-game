...
Nach dem Ankündigungs-Countdown beginnt eine fünfsekündige Rollenwahl direkt in der Auktionsarena. Zwei statische Richtungstasten verändern ihre Position nicht: Nach oben bewegt sich die Figur über die neutrale Mitte zur Verkäuferseite, nach unten zur Käuferseite. Die Mittelposition bedeutet weiterhin Nichtteilnahme. Kurzes Tippen bewegt einen Schritt; längeres Berühren lässt die Figur bis zum Loslassen weiterlaufen und hebt den gehaltenen Pfeil sichtbar hervor. Bis zum Ablauf der Positionierungszeit darf die Auswahl geändert werden; danach ist die Rolle für diese Ressourcenauktion festgelegt. Dieselben Richtungstasten steuern anschließend die Preisbewegung, ohne ihren Platz zu wechseln. Ihre Rollenbezeichnungen verschwinden dann, sodass nur die beiden großen Richtungspfeile verbleiben.
